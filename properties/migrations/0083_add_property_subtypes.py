# Generated by Django 3.1 on 2021-03-02 00:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('properties', '0082_auto_20210216_0125'),
    ]

    operations = [
        migrations.CreateModel(
            name='CabinAttributes',
            fields=[
        ...
        migrations.AddField(
            ...
            name='subtype',
            field=models.CharField(blank=True, choices=[('block_apartment', 'Block apartment'), ('villa_apartment', 'Villa apartment')], max_length=50, null=True, verbose_name='Apartment subtype'),
        ),
        migrations.AddField(
            model_name='commercialattributes',
            name='subtype',
            field=models.CharField(blank=True, choices=[('commercial_space', 'Commercial space'), ('office_space', 'Office space'), ('industrial_space', 'Industrial space')], max_length=50, null=True, verbose_name='Commercial subtype'),
        ),
        migrations.AddField(
            model_name='hotelattributes',
            name='subtype',
            field=models.CharField(blank=True, choices=[('hotel', 'Hotel'), ('guest_house', 'Guest house')], max_length=50, null=True, verbose_name='Hotel subtype'),
        ),
        migrations.AddField(
            model_name='houseattributes',
            name='subtype',
            field=models.CharField(blank=True, choices=[('detached', 'Detached house'), ('terraced', 'Terraced house'), ('attached', 'Attached house')], max_length=50, null=True, verbose_name='House subtype'),
        ),
        migrations.AddField(
            model_name='landattributes',
            name='subtype',
            field=models.CharField(blank=True, choices=[('agricultural_land', 'Agricultural land'), ('construction_land', 'construction_land')], max_length=50, null=True, verbose_name='Land subtype'),
        ),
        migrations.AddField(
            model_name='studioattributes',
            name='subtype',
            field=models.CharField(blank=True, choices=[('studio_apartment', 'Studio apartment')], max_length=50, null=True, verbose_name='Studio subtype'),
        ),
        migrations.AlterField(
            model_name='featuregroup',
            name='property_type',
            field=multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('house', 'House'), ('apartment', 'Apartment'), ('studio', 'Studio'), ('commercial', 'Commercial space'), ('land', 'Land'), ('hotel', 'Hotel'), ('cabin', 'Cabin')], max_length=56, null=True, verbose_name='Property type'),
        ),
        migrations.AlterField(
            model_name='property',
            name='type',
            field=models.CharField(blank=True, choices=[('house', 'House'), ('apartment', 'Apartment'), ('studio', 'Studio'), ('commercial', 'Commercial space'), ('land', 'Land'), ('hotel', 'Hotel'), ('cabin', 'Cabin')], max_length=56, null=True, verbose_name='Type'),
        ),
    ]
